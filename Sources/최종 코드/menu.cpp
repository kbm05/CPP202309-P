...
Coffee::Coffee() {
	name = "COFFEE";
	menu = { Cafe("에스프레소", 2000), Cafe("아메리카노", 2500),
...
NonCoffee::NonCoffee() {
	name = "NON_COFFEE";
	menu = { Cafe("곡물라떼", 3300), Cafe("고구마라떼", 3500), Cafe("초코라떼", 3500),
			Cafe("그린티라떼", 3500), Cafe("민트초코라떼", 3500), Cafe("딸기라떼", 3700) };
}
...
Smoothie::Smoothie() {
	name = "SMOOTHIE";
	menu = { Cafe("스무디", 4000), Cafe("요거트스무디", 4500) };
...
Ade::Ade() {
	...
	menu = { Cafe("자몽에이드", 4000), Cafe("레몬에이드", 4000), Cafe("유자에이드", 4000),
			 Cafe("청포도에이드", 4300), Cafe("패션후르츠에이드", 4300) };
}
void Ade::Print() {
